  ...
  return (
    <header>
      <nav className="flex justify-between items-center py-8">
        ...
        <button className="hidden max-[900px]:block" onClick={handleMenu}>
          <Icon
      ...
      <nav className={`w-full h-[50%] hidden ${menu && "!block"}`}>
        <ul className="flex flex-col gap-8 items-center">
          <li>
            <a
              href="#"
              className="font-semibold text-light-gray hover:text-primary-orange duration-200">
              Home
            </a>
            <hr className="absolute mt-2 w-0 h-[2px] border-none bg-primary-orange group-hover:!w-[50%] duration-200 ease-linear" />
          </li>
      ...
      <section className="relative mt-10 flex items-center justify-between max-lg:justify-center">
        <div className="w-[50%] max-lg:w-[80%] max-lg:mt-12">
          ...
          <p className="text-light-gray my-6">
            ...
            fitter, and more confident you. Sign up for{" "}
        ...
        <span className="absolute -bottom-16 right-16 opacity-10 -z-10 text-[35rem] font-medium text-primary-orange select-none max-lg:hidden">
          O
        </span>
        <span className="absolute -bottom-16 left-56 opacity-5 -z-10 text-[10rem] font-bold select-none max-lg:hidden">
          FITNESS
        </span>
